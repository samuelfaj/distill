...
Learn how to install, configure, and extend Distill, the terminal-based AI coding assistant from Samuel Fajreldines.
...
Automate, script, and integrate Distill with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `distill -p`, output formats, CI/CD integration, and piping |
