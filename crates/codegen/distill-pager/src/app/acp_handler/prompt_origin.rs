...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    distill_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        distill_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        distill_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        distill_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        distill_shell::session::PromptOrigin::TaskCompleted { .. }
            | distill_shell::session::PromptOrigin::SubagentCompleted { .. }
            | distill_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | distill_shell::session::PromptOrigin::ParentAgentMessage { .. }
            | distill_shell::session::PromptOrigin::ParentHumanMessage { .. }
            | distill_shell::session::PromptOrigin::NotificationDrain
    )
}
