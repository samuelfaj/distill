...
use distill_shell::extensions::notification::MemoryDisabledReason;
...
fn empty_state_markdown(capture_enabled: bool, dream_enabled: bool) -> String {
    ...
    text.push_str(
        "\nDistill remembers conventions, decisions, and project facts across sessions so you \
...
Memory was turned off when Distill started, so it can't be turned on here. Anything already \
...
This session reports a reason this version of Distill doesn't recognize; press **t** to try \
turning it back on."
        }
    }
}
...
impl MemoryModalState {
    ...
    #[cfg(test)]
    fn query_viewport(&self, width: usize) -> distill_ratatui_textarea::SingleLineViewport {
...
pub fn build_entries(
    files: Vec<distill_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
fn entry_label(f: &distill_shell::extensions::notification::MemoryFileInfo) -> String {
...
mod tests {
    ...
    fn observation_labels_prefer_title_then_readable_key() {
        use distill_shell::extensions::notification::MemoryFileInfo;
    ...
    fn confirmed_delete_sends_forget_and_applies_reply() {
        ...
        state.apply_forget_result(
            ...
            Ok(MemoryForgetResponse::Rejected {
                reason: distill_shell::extensions::memory::MemoryForgetRejection::DreamRunning,
    ...
    fn empty_enabled_state_renders_onboarding_copy() {
        ...
        let manifest = |scope: &str| distill_shell::extensions::notification::MemoryFileInfo {
        ...
        let mut with_topic = MemoryModalState::new(build_entries(vec![
            manifest("global"),
            manifest("workspace"),
            distill_shell::extensions::notification::MemoryFileInfo {
