...
use distill_acp_lib::AcpResult;
use distill_markdown::StreamingMarkdownRenderer;
pub use distill_tools::implementations::distill::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<distill_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: distill_telemetry::events::SuperGrokUpsell,
    },
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> distill_tools::implementations::distill::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: distill_tools::implementations::distill::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
...
mod tests {
    ...
    fn chrome_height_option_less_question_drops_the_label_gap() {
        ...
        let q = make_question("How can we improve Distill?", &[], false);
        assert_eq!(
            chrome_height(
                &q,
                80,
