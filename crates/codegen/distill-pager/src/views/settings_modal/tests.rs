...
fn fork_secondary_model_picker_opens_on_persisted_model() {
    ...
    assert_ne!(slug, distill_shell::models::default_model());
    let snapshot = PagerLocalSnapshot {
        available_models: vec![
...
fn picker_long_description_wraps_to_multiple_lines() {
    let entries = vec![SettingMeta {
        ...
        description: "Controls whether the Grok provider may retain and train on coding data.",
        keywords: &["test"],
        kind: SettingKind::Enum {
            default: "opt-out",
            choices: &[
                EnumChoice {
                    canonical: "opt-in",
                    display: "Opt in",
                    description: "Allow Samuel Fajreldines to retain and use coding session data for training and product improvement.",
                },
                EnumChoice {
                    canonical: "opt-out",
                    display: "Opt out",
    ...
    assert!(
        r3.contains("Allow Samuel Fajreldines"),
...
fn picker_multi_line_choice_hit_rect_spans_all_lines() {
    ...
    let entries = vec![SettingMeta {
        ...
        owner: SettingOwner::Shared,
        label: "Coding data sharing",
        description: "Controls whether the Grok provider may retain coding data.",
        keywords: &["test"],
        kind: SettingKind::Enum {
            default: "opt-in",
            choices: &[
