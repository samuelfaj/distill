...
use distill_workspace::permission::mcp_pretty_name_if_qualified;
...
pub struct TurnStatusArgs<'a> {
    ...
    /// What the Jev decision layer did for this turn (see `distill_shell::jev::turn_activity`).
    pub jev: distill_shell::jev::JevTurnActivity,
...
mod tests {
    ...
    fn cancelling_keeps_stop_button_clickable() {
        ...
        let output = render_turn_status(
            ...
            TurnStatusArgs {
                ...
                jev: distill_shell::jev::JevTurnActivity::default(),
                parked: false,
    ...
    fn render_running_with_jev(jev: distill_shell::jev::JevTurnActivity) -> String {
    ...
    fn jev_chip_reports_use_refusal_and_flight() {
        use distill_shell::jev::JevTurnActivity;
