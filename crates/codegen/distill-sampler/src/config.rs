...
//! It deliberately does **not** alias `distill_sampling_types::SamplingConfig`.
//! Aliasing would pull transitive dependencies on shell-specific types (`distill-tools`, etc.) into the sampler crate.
