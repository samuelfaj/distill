...
/// Grok-specific session notification (parallel to acp::SessionNotification).
...
impl PromptUsage {
    ...
    pub(crate) fn project_from_ledger(
        ledger: Option<&distill_chat_state::UsageLedger>,
        incomplete: bool,
    ) -> Option<Self> {
...
impl From<&distill_chat_state::UsageTotals> for PromptUsageModel {
    fn from(t: &distill_chat_state::UsageTotals) -> Self {
        ...
        let distill_chat_state::UsageTotals {
            input_tokens,
            output_tokens,
            cached_read_tokens,
...
impl From<&distill_chat_state::UsageLedger> for PromptUsage {
    fn from(ledger: &distill_chat_state::UsageLedger) -> Self {
        let mut usage = Self {
...
pub enum SessionUpdate {
    ...
    SessionStatus(Box<distill_status_line::StatusLineContext>),
...
pub struct CompactionSegmentFile {
    pub items: Vec<distill_sampling_types::ConversationItem>,
    /// Curated summary, analysis tags already stripped.
    pub summary: String,
    pub detail: distill_chat_state::CompactionDetail,
...
pub struct CompactionRequestFile {
    ...
    /// `"short"` is the concise self-summarization; `"detailed"` is the 10-section structured prompt for Distill and similar agents.
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub attempt_details: Vec<distill_chat_state::compaction_utils::CompactionAttempt>,
}
...
mod tests {
    ...
    fn compaction_request_file_v2_roundtrips_attempt_details() {
        use distill_chat_state::compaction_utils::CompactionAttempt;
