...
pub async fn pull_session_to_local(
    ...
    if let Err(e) = crate::util::distill_home::ensure_sessions_cwd_dir(cwd) {
...
pub(crate) mod hydrate {
    ...
    pub(super) fn write_to_dir(
        ...
        crate::util::distill_home::create_dir_all_owner_only(dir).map_err(|e| io_err(dir, e))?;
    ...
    fn write_summary(
        ...
        let mut summary = Summary {
            ...
            head_branch: None,
            request_id: None,
            // Record the *local* distill_home (where this hydrated copy lives), not the original remote session's, since reconstruction runs locally
            distill_home: crate::session::persistence::distill_home_string(),
            last_active_at: None,
            generated_title,
            title_is_manual,
            worktree_label: None,
            ...
            sandbox_profile: distill_sandbox::configured_profile_name().map(String::from),
