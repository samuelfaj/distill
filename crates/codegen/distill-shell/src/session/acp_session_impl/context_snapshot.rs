...
impl SessionActor {
    ...
    pub(super) async fn emit_session_context_snapshot(&self) {
        if !self.telemetry_enabled || !distill_telemetry::is_session_metrics_enabled() {
            return;
        }
        ...
        // `/tokenize-text` is the Distill tokenizer
        ...
        distill_telemetry::session_ctx::log_session_event(session_context_snapshot(
