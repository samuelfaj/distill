...
use distill_workspace::jev::JevClient;
use distill_workspace::jev::permission::{JevAsker, JevAuthority, JevPermissionClassifier};
use distill_workspace::jev::policy::DecisionSink;
use distill_workspace::jev::questions::PermissionThresholds;
use distill_workspace::permission::{ClassifierVerdict, FixedClassifier, SharedClassifier};
...
mod tests {
    ...
    use distill_workspace::permission::HeuristicPermissionClassifier;
