...
fn verifier_template_renders_per_agent_type_and_falls_back() {
    ...
    tool_names.insert(
        distill_tools::types::tool::ToolKind::Read,
        "cursor_read".to_string(),
    );
    tool_names.insert(
        distill_tools::types::tool::ToolKind::ListDir,
        "cursor_ls".to_string(),
    );
    tool_names.insert(
        distill_tools::types::tool::ToolKind::Search,
    ...
    // Distill explicit render: no leftover placeholder either.
    let grok = RoleToolNames::from_summary(&summary_with(&[
        (distill_tools::types::tool::ToolKind::Read, "read_file"),
        (distill_tools::types::tool::ToolKind::ListDir, "list_dir"),
        (distill_tools::types::tool::ToolKind::Search, "grep"),
    ]))
...
fn cold_and_resume_renders_are_symmetric_for_an_index() {
    let summary = summary_with(&[
        (distill_tools::types::tool::ToolKind::Read, "cursor_read"),
        (distill_tools::types::tool::ToolKind::ListDir, "cursor_ls"),
        (distill_tools::types::tool::ToolKind::Search, "cursor_grep"),
    ]);
