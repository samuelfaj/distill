...
/// Persist the pager's four-step onboarding completion marker.
pub async fn set_onboarding_completed(value: bool) -> Result<()> {
    update_config(|cfg| cfg.ui.onboarding_completed = value).await
}
