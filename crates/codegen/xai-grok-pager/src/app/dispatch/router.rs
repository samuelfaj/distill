...
use super::settings::setters::{
    ...
    set_cheap_model, set_follow_up_behavior, set_fork_secondary_model, set_group_tool_verbs,
    set_hunk_tracker_mode, set_tier_light,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetCheapModel(v) => set_cheap_model(app, v),
        Action::SetTierLight(v) => set_tier_light(app, v),
